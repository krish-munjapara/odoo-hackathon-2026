      ...
      <div className="lg:w-1/4 hidden lg:block">
        <div className="sticky top-24 space-y-6">
          <div className="glass-card p-6">
            ...
            <h2 className="text-xl font-bold text-white mb-2">Jaipur Explorer</h2>
            <p className="text-sm text-slate-400 flex items-center gap-2 mb-4"><Calendar size={14} /> Dec 20 - Dec 26</p>
            
            <div className="space-y-2 border-t border-slate-800 pt-4">
              <a href="#day1" className="block text-accent-cyan font-medium py-1">Day 1 - Arrival</a>
              <a href="#day2" className="block text-slate-400 hover:text-white transition-colors py-1">Day 2 - City Palace</a>
              <a href="#day3" className="block text-slate-400 hover:text-white transition-colors py-1">Day 3 - Amer Fort</a>
            </div>
          </div>
          ...
          <div className="glass-card p-6 bg-gradient-to-br from-slate-900 to-primary-blue/10">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="font-bold text-white text-lg">32°C</h3>
                <p className="text-sm text-slate-400">Sunny, Dry</p>
              </div>
            </div>
      ...
      <div className="lg:w-3/4 space-y-12">
        ...
        <section id="day1" className="scroll-mt-24">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white">Arrival & Check-in</h2>
          ...
          <div className="space-y-6 relative before:absolute before:inset-0 before:ml-6 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-700 before:to-transparent">
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] glass-card p-6 group-hover:border-accent-cyan/50 transition-colors">
                ...
                <p className="text-slate-400 text-sm mb-4">Hotel Rajputana Palace. Confirmation #JPR2849</p>
                <div className="flex items-center gap-4 text-xs text-slate-500">
                  <span className="flex items-center gap-1"><MapPin size={12} /> MI Road, Jaipur</span>
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] glass-card p-6 group-hover:border-accent-purple/50 transition-colors">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="text-lg font-bold text-white">Hawa Mahal Visit</h3>
                  <span className="text-sm font-medium text-accent-purple bg-accent-purple/10 px-2 py-1 rounded-md">16:00</span>
                </div>
                <p className="text-slate-400 text-sm mb-4">Explore the iconic Palace of Winds and enjoy the city view from its windows.</p>
                <div className="flex items-center gap-4 text-xs text-slate-500">
                  <span className="flex items-center gap-1"><MapPin size={12} /> Old City, Jaipur</span>
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] glass-card p-6 group-hover:border-yellow-500/50 transition-colors">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="text-lg font-bold text-white">Dinner at Chokhi Dhani</h3>
                ...
                <p className="text-slate-400 text-sm mb-4">Traditional Rajasthani thali dinner with folk dance performance!</p>
                <div className="flex items-center gap-4 text-xs text-slate-500">
                  <span className="flex items-center gap-1 text-accent-emerald"><DollarSign size={12} /> Est. ₹1,200</span>
                </div>
              </div>
            </div>
        ...
        <div className="glass-card p-6 border-t-4 border-accent-emerald/50 mt-12">
          <div className="flex justify-between items-center">
            ...
            <div className="text-3xl font-bold text-accent-emerald">₹3,500</div>
          </div>
        </div>
      </div>
    </div>
